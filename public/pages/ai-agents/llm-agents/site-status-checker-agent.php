...
<div>
    <?= create_example_of_use_links(APP_PATH . 'public/include/classes/llmagents/salesanalysis/SiteStatusCheckerAgent.php', title: 'Example of class <code>SiteStatusCheckerAgent</code>', opened: true); ?>
</div>
