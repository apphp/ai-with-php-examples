...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group">
            <a href="<?=create_href('mathematics-for-ml', 'eigenvalues-and-eigenvectors', 'rubix-eigenvalues-and-eigenvectors')?>" class="btn btn-sm btn-outline-primary">Show Code</a>
        </div>
    </div>
</div>
