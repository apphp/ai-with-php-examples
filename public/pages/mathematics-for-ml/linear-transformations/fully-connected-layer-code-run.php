...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group">
            <a href="<?=create_href('mathematics-for-ml', 'linear-transformations', 'fully-connected-layer')?>"  class="btn btn-sm btn-outline-primary">Show Code</a>
        </div>
    </div>
</div>
...
<div class="container-fluid px-2">
    <div class="row justify-content-start p-0">
        ...
        <div class="col-md-12 col-lg-5 p-0 m-0">
            <form action="<?= APP_SEO_LINKS ? create_href('mathematics-for-ml', 'linear-transformations', 'fully-connected-layer-code-run') : 'index.php'; ?>" type="GET">
