...
<div>
    ...
    <ui class="list">
        <li><a href="<?= create_href('mathematics-for-ml', 'scalars', 'mathphp-scalar-operations') ?>">Scalars with MathPHP</a></li>
    </ui>
    ...
    <ui class="list">
        <li><a href="<?= create_href('mathematics-for-ml', 'scalars', 'php-scalar-operations') ?>">Scalars with Pure PHP</a></li>
    </ui>
</div>
