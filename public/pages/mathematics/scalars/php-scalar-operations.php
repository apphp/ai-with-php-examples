...
<?= create_run_code_button('Scalar Operations with PHP', 'mathematics', 'scalars', 'php-scalar-operations-run'); ?>
...
<div>
    <?= create_example_of_use_links(APP_PUBLIC_PATH . 'include/classes/mathematics/Scalar.php', title: 'Example of class <code>Scalar</code>', opened: true); ?>
</div>
