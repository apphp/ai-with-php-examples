...
<div>
    <?= create_example_of_use_links(APP_PUBLIC_PATH . 'include/classes/search/InformedSearchGraph.php', title: 'Example of class <code>InformedSearchGraph</code> (with A* Graph search)', opened: true); ?>
</div>
