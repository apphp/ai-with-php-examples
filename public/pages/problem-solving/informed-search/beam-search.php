...
<div>
    <?= create_example_of_use_links(APP_PATH . '/public/include/classes/InformedSearchGraph.php', title: 'Example of class <code>InformedSearchGraph</code> (with Beam search)', opened: true); ?>
</div>
