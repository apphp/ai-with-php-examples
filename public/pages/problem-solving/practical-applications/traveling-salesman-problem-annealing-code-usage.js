                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="row">
                            ...
                            <div className="col-6">{temperature.toFixed(2)}</div>
                            ...
                            <div className="col-6">{calculateRouteDistance(currentRoute).toFixed(1)}</div>

                            <div className="col-6 fw-bold">Best Distance:</div>
                            <div className="col-6">{bestDistance.toFixed(1)}</div>
                        </div>
                    </div>
                </div>
            </div>
