...
<div>
    <?= create_example_of_use_links(APP_PATH . 'public/include/classes/UninformedSearchGraph.php', title: 'Example of class <code>UninformedSearchGraph</code> (with BFS search)', opened: true); ?>
</div>
