...
<div>
    <?= create_example_of_use_links(APP_PUBLIC_PATH . 'include/classes/search/UninformedSearchGraph.php', title: 'Example of class <code>UninformedSearchGraph</code> (with BFS search)', opened: true); ?>
</div>
