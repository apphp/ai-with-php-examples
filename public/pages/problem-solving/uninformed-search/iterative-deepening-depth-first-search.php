...
<div>
    <?= create_example_of_use_links(APP_PATH . 'public/include/classes/search/UninformedSearchGraph.php', title: 'Example of class <code>UninformedSearchGraph</code> (with IDDFS search)', opened: true); ?>
</div>
