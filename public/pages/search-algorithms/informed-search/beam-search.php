...
<?= create_run_code_button('Beam Search', 'search-algorithms', 'informed-search', 'beam-search-code-run'); ?>
...
<div>
    <?= create_example_of_use_links(__DIR__ . '/informed-graph-code.php', title: 'Example of class <code>InformedSearchGraph</code> (with Beam search)', opened: true); ?>
</div>
