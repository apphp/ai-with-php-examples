...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group">
            <a href="<?= create_href('search-algorithms', 'informed-search', 'greedy-search') ?>" class="btn btn-sm btn-outline-primary">Show
                Code</a>
        </div>
    </div>
</div>
...
<div>
    ...
    <div class="collapse pb-4" id="collapseExampleOfUse">
        ...
        <code id="code">
            <?= highlight_file(dirname(__FILE__) . '/greedy-search-code-usage.php', true); ?>
        </code>
    </div>
</div>
