...
<?= create_run_code_button('Hill Climbing Search', 'search-algorithms', 'informed-search', 'hill-climbing-search-code-run'); ?>
...
<div>
    <?= create_example_of_use_links(__DIR__ . '/informed-graph-code.php', title: 'Example of class <code>InformedSearchGraph</code> (with Hill Climbing search)', opened: true); ?>
</div>
