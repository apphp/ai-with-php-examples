...
<?= create_run_code_button('Iterative Deepening A*', 'search-algorithms', 'informed-search', 'iterative-deepening-a-search-code-run'); ?>
...
<div>
    <?= create_example_of_use_links(__DIR__ . '/informed-graph-code.php', title: 'Example of class <code>InformedSearchGraph</code> (with Iterative Deepening A* search)', opened: true); ?>
</div>
