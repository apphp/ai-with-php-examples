...
<?= create_run_code_button('Iterative Deepening Depth-First Search (IDDFS)', 'search-algorithms', 'uninformed-search', 'iterative-deepening-depth-first-search-code-run'); ?>
